...
public class StreamingSourceToGcsParquet {

  private static final Logger LOG = LoggerFactory.getLogger(StreamingSourceToGcsParquet.class);
    ...
    pipeline
        ...
        .apply(
            ...
            WriteFormatToFileDestination.<GenericRecord>create()
                ...
                .withSinkProvider(() -> ParquetIO.sink(new Schema.Parser().parse(schemaStr)))
